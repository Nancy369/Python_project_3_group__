...
#get the file
file_path = './datasets/factor_disease_female.csv'
...
plt.title('Coefficients of disease Factors on Female Cardiovascular Diseases Risk Prediction')
plt.xlabel('Factors')
plt.xticks(rotation=30)
plt.ylabel('Coefficient Value')
plt.savefig('./results_picture/Coefficients of disease Factors on Female Cardiovascular Diseases Risk Prediction')
plt.show()