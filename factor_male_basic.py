...
#get the file
file_path = './datasets/factor_basic_male.csv'
...
plt.title('Coefficients of basical Factors on Male Cardiovascular Diseases Risk Prediction')
plt.xlabel('Factors')
plt.ylabel('Coefficient Value')
plt.savefig('./results_picture/Coefficients of basical Factors on Male Cardiovascular Diseases Risk Prediction')
plt.show()
