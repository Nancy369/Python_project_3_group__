...
#get the file
file_path = './datasets/factor_health_female.csv'
...
plt.title('Coefficients of health Factors on Female Cardiovascular Diseases Risk Prediction')
plt.xlabel('Factors')
plt.xticks(rotation=16)
plt.ylabel('Coefficient Value')
plt.savefig('./results_picture/Coefficients of health Factors on Female Cardiovascular Diseases Risk Prediction')
plt.show()